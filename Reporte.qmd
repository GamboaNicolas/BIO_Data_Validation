...
Las reglas pueden agruparse en 3 grandes grupos o campos: existencia, rango y consistencia. Según lo que evalúa cada regla definida, se le fue asignado un campo para asi poder, al igual que en el apartado anterior, observar cuál es el que más fallas tiene:
...
Tal como se mencionó anteriormente, la regla que se incumple en la gram mayoría de los casos es la número 10, por lo que podemos concluir que la mayoría de las inconcistencias se deben a que se produjo un error al momento de tomar la decisión de si la mujer debe ser o no enrolada en el estudio. A su vez las reglas 5 y 12, ambas relacionadas con la Etnia de la persona, cuentan con un número llamativo de incumplimientos, por lo que sería adecuado investigar a qué se deben estas inconcistencias.
